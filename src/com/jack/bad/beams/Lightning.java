...
public class Lightning extends BIM {

public final static String type = "Lightning";
	
	public final static String displayName = "Lightning";
	...
	public void detonateBIM(Location loc) {
		Explosions.lightning(loc, explosionRadius);
	}
